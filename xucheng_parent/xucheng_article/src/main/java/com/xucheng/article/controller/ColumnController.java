...
import com.xucheng.article.service.ColumnService;
...
public class ColumnController {
	...
	/**
	* @Description: 随机查询专栏用户以供推荐
	* @Param: [searchMap, page, size]
	* @return: entity.Result
	* @Author: yangxucheng
	* @Date: 2019/3/26 11:37
	*/
	@RequestMapping(value="/search/rand/{userid}",method=RequestMethod.POST)
	public Result findSearchAuthor(@PathVariable String userid){
		List<HashMap<String, Object>> lists = columnService.findSearchByRand(userid);
	...
	public Result add(@RequestBody Column column  ){
		System.out.println(column.getSummary());
