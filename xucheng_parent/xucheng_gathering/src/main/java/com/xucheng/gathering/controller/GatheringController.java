package com.xucheng.gathering.controller;
...
import com.xucheng.gathering.service.GatheringService;
...
public class GatheringController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/searchByEnrollTime/{page}/{size}",method=RequestMethod.POST)
	public Result findAllByEnrollTime(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		Page<Gathering> pageList = gatheringService.searchByEnrollTime(searchMap, page, size);
