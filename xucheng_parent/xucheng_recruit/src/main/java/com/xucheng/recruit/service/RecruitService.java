package com.xucheng.recruit.service;

import com.xucheng.recruit.dao.RecruitDao;
...
public class RecruitService {
	...
	public List<Recruit> getRecmmendRecruit(String state) {
		return recruitDao.findTop6ByStateOrderByCreatetimeDesc(state);
	}

	public List<Recruit> getNewestRecruit(String state) {
