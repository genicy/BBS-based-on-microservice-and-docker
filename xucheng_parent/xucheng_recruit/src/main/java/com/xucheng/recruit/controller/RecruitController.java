package com.xucheng.recruit.controller;

import com.xucheng.recruit.pojo.Recruit;
import com.xucheng.recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result getRecmmend(){
		List<Recruit> list = recruitService.getRecmmendRecruit("2");
		return new Result(true,StatusCode.OK,"查询成功",list);
	}
	@GetMapping("/search/newlist")
	public Result getNewest(){
		List<Recruit> list = recruitService.getNewestRecruit("0");
		return new Result(true,StatusCode.OK,"查询成功",list);
	}
	/**
	 * 查询全部数据
	...
	public Result add(@RequestBody Recruit recruit  ){
		System.out.print("test:"+recruit.toString());
